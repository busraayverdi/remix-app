  ...
  return (
      <section className="overflow-hidden bg-white rounded-xl shadow:md hover:shadow-lg w-96 ">
        ...
        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
          ...
          <span class="inline-flex items-center rounded-md bg-yellow-50 px-2 py-1 text-xs font-medium text-yellow-800 ring-1 ring-inset ring-yellow-600/20">{product.badge}</span>
